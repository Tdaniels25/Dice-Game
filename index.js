...
function disableButtons() {
  document.querySelector(".butn_roll").disabled = true;
...
function enableButtons() {
  document.querySelector(".butn_roll").disabled = false;
  document.querySelector(".btn_hold").disabled = false;
}

// Event listener for the "Roll Dice" button
document.querySelector(".butn_roll").addEventListener("click", function() {
